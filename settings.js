...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'SUPUN-MD=uJ9RTQSA#d_T2BjIk0Qf2kAZkifIyjM7ZkfsiDiE7m44a6Vm2-2A' : process.env.SESSION_ID,
...
AI_IMAGE: process.env.AI_IMAGE === undefined ? "false" : process.env.AI_IMAGE,
MATHS_AI: process.env.MATHS_AI === undefined ? "false" : process.env.MATHS_AI,
...
LOGO: process.env.LOGO === undefined ? "https://i.ibb.co/mVJg1Ljn/Supunmd.jpg" : process.env.LOGO,
